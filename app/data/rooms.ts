...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    description:
      "Bahçe manzaralı odamızın odaya özel olarak ayrılmış balkonda kahvaltınızı yapabilirsiniz. Oda içinde oturma bölümü ve jakuzi alanı bulunmaktadır.Banyo bölümü geniş ve havalandırma desteklidir.Oda içi özel aydınlatma bulunmaktadır. Odada akıllı tv ve oturma alanı, minibar, klima, ütü, ütü masası, kahve ve çay ikramı bulunmaktadır.",
    features: [
      "Büyük Yatak",
      "WiFi",
      "Akıllı TV",
  ...
  },
  {
    ...
    description:
      "Odanın içerisinde bulunan jakuzi ile günün yorgunluğunu atabilirsiniz.Banyo bölümü odaiçinde ayrı olarak bulunmaktadır. Odada akıllı tv, minibar, ütü, ütü masası, kahve ve çay ikramı bulunmaktadır.",
    features: [
      "Büyük Yatak",
      "WiFi",
      "TV",
  ...
  },
  {
    ...
    description:
      "Odanın içerisinde geniş çift kişilik yatak bulunmaktadır.Odaya ek yatak atılabilir.Banyo içerisinde jakuzi bulunmaktadır.Odada tv, ütü, ütü masası, kahve ve çay ikramı bulunmaktadır.",
    features: [
      "Büyük Yatak",
      "WiFi",
      "TV",
